...
#  - is_admin (getter, setter, and deleter) – This property should validate that the user is authorized to modify 
# the is_admin attribute and provide appropriate error messages for unauthorized attempts.